            ...
            <section class="carousels container-fluid mainsection p-0">
                <div id="carousel1" class="carousel slide" data-bs-ride="carousel">
                    <div class=carousel-inner>
                        <div class="carousel-item active">
                            <div class="row images">
                                <div class="col-md-12 col-lg-6 mx-auto">
                                    <img src="../images/IMG_0948_copie.jpg" class="img-fluid rounded-4" alt="Battements Telluriques - Image 1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <div class="row images">
                                <div class="col-md-12 col-lg-6 mx-auto">
                                    <img src="../images/IMG_1075.jpg" class="img-fluid rounded-4" alt="Battements Telluriques - Image 2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <div class="row images">
                                <div class="col-md-12 col-lg-6 mx-auto">
                                    <img src="../images/IMG_1956.jpg" class="img-fluid rounded-4" alt="Battements Telluriques - Image 3">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <div class="row images">
                                <div class="col-md-12 col-lg-6 mx-auto">
                                    <img src="../images/IMG_0834.JPG" class="img-fluid rounded-4" alt="Battements Telluriques - Image 4">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <div class="row images">
                                <div class="col-md-12 col-lg-6 mx-auto">
                                    <img src="../images/Depliant_Recto_Verso.jpg" class="img-fluid rounded-4" alt="Battements Telluriques - Image 5">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="separator col-md-12">
                    <div class="carousel1-text d-flex h-100">
                        <!-- <div class="container-md col-2 text-center"> -->
