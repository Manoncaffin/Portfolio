...
<body>
    ...
    <main>
        ...
        <section id="contact" class="container-md-12 m-0 pt-5 pl-2 d-flex justify-content-center slide-in">
            <div id="infos"></div>
            ...
            <div class="col-md-4">
                ...
                <div class="col-auto pt-5">
                    <a href="../images/CV_2024.pdf" class="textInfos1 px-4 text-black text-decoration-none">Curriculum vitae</a><br>
            ...
            <div class="container-fluid">
                <div class="col-md-8">
                    ...
                    <p class="textInfos2 m-0 text-black">Ayant évolué dans un cadre créatif, je souhaite trouver un stage qui puisse mêler le front-end et le back-end afin de solidifier les connaissances que j'ai acquises de par ma formation et mes expériences passées, mais également pour solidifier les connaissances que j'apprends à acquérir en centre de formation.</p>
                    <div class="col-auto pt-4">
